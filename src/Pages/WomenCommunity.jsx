        ...
        <>
            ...
            <div className="orphan-support-programm-wrapper">
                <section className="orphan-section">
                    <div className="orphan-content">
                        <h2 className="orphan-heading">WOMEN’S COMMUNITY GARDENS</h2>
                        <p className="orphan-text">
                            Food security is one of the biggest challenges facing underserved communities. Many widows and women struggle to provide meals for their families or earn enough income to support them.
                            AKAFI’s Women’s Community Gardens Program empowers women with seeds, fertilizers, tools, and basic agricultural training so they can grow their own food, feed their families, and build financial independence.
                        </p>
                        <p className="orphan-text">
                            A single garden becomes more than a source of food it becomes stability, growth, and hope.
                        </p>
            ...
            <section className="orphan-row">
                ...
                <div className="orphan-col orphan-col--right">
                    <h3 className="orphan-title">Why Garden Support Matters</h3>
