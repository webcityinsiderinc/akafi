...
import programm from "../images/support-program.jpg"
import Cards from '../Components/Cards'
import edu from "../images/edu-support.jpg"
...
function OrphanSupportProgramm() {
        ...
        <>
            ...
            <div className="orphan-support-programm-wrapper">
                <section className="orphan-section">
                    <div className="orphan-content">
                        <h2 className="orphan-heading">ORPHAN SUPPORT PROGRAMS</h2>
                        <p className="orphan-text">
                            Every child deserves the chance to learn, grow, and feel valued yet many orphans in underserved communities are held back simply because they lack school uniforms, shoes, or basic supplies. At AKAFI, we remove these barriers by providing children with the essentials they need to return to school with confidence.
                        </p>
                        <p className="orphan-text">
                            Our program restores dignity, builds hope, and gives orphans the opportunity to step into a brighter future.
                        </p>
            ...
            <section className="orphan-row">
                ...
                <div className="orphan-col orphan-col--right">
                    <h3 className="orphan-title">Why Education Support Matters</h3>
                    <p className="orphan-intro">
                        Supporting the education of orphans is one of the most powerful ways to break the cycle of poverty.
                        This program is essential because it: </p>
                    <ul className="orphan-bullets">
                        <li>Restores confidence and emotional stability in children who have suffered loss.</li>
                ...
                <section className="orphan-support">
                    <div className="container">
                        ...
                        <div className="left">
                            ...
                            <p>
                                AKAFI’s Orphan Support Program focuses on removing the barriers that
                                keep children out of the classroom. Our approach goes beyond
                                uniforms — we strengthen the full support system around each child,
                                ensuring long-term educational stability and emotional well-being.
                            </p>
                        </div>
...
export default OrphanSupportProgramm